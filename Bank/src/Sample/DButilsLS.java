...
public class DButilsLS {
        ...
        static final String PASS = "شمه.ذ";
        ...
        public static void singUp(ActionEvent e,String name,String lastName, String userName, String email,String password,
                                  String confirmPass, String oppeningdate , String availibility, String withdraw
                               ,String deposit, String accounttype, String newcaptha,String accountnumber ) {
        ...
        public static void loninUser(ActionEvent event, String username, String password) {
            Connection connection = null;
